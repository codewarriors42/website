...
//                 popup.children[2].children[0].classList.add("rem");
//             } else if (
//                 popup.children[0].textContent === "Competitive Programming"
//             ) {
//                 popup.children[2].children[1].setAttribute(
//                     "href",
//                     card.children[3].textContent
...
//                 popup.children[2].children[0].setAttribute(
//                     "href",
//                     "https://techathlon.code-warriors.org/"
//                 );
//                 popup.children[2].children[0].textContent = "Start";
...
//             document.querySelector(".cards-container").style.pointerEvents =
//                 "none";
...
const meshContainer = document.querySelector(".mesh-hold");
const parallaxInstance = new Parallax(meshContainer, {
    relativeInput: true,
});
